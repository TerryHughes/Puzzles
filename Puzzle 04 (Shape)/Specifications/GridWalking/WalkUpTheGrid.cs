//-----------------------------------------------------------------------
// <copyright file="WalkUpTheGrid.cs" company="THughes">
...
namespace THughes.Puzzles.Shape.Specifications.GridWalking
{
    ...
    /// <summary>
    /// Represents a walk up the grid unit of logic that can be evaluated.
    /// </summary>
    internal class WalkUpTheGrid : GridWalker
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WalkUpTheGrid" /> class.
        /// </summary>
        ...
        internal WalkUpTheGrid(int pointRow, int rowDifference, int point, double walker, double adjustment, Func<IEnumerable<int>, double, bool> evaluator) : base(pointRow, rowDifference, point, walker, adjustment, evaluator)
        {
        }
